    ...
    public partial class SkladnikiCzynszuLokalu : Strona
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            using (DostępDoBazy.CzynszeKontekst db = new DostępDoBazy.CzynszeKontekst())
            {
                ...
                placeOfTable.Controls.Add(new Kontrolki.Table("mainTable tabTable", wiersze, new string[] { "Lp.", "Nr", "Nazwa", "Stawka", "Ilość", "Wartość", "Początek zakresu dat", "Koniec zakresu dat" }, new Kontrolki.InformacjeOSortowalnościTablicy(), String.Empty, new List<int>() { 1, 2, 4, 5, 6 }, new List<int>() { 6 }, String.Empty));
            }
        }
    }
}