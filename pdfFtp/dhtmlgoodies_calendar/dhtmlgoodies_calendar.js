...
switch(languageCode){
	...
	case "cz":	/* Czech */
		...
		break;	
	case "pl":	/* Polish */
		var monthArray = ['Styczen','Luty','Marzec','Kwiecien','Maj','Czerwiec','Lipiec','Sierpien','Wrzesien','Pazdziernik','listopad','Grudzien'];
		var monthArrayShort = ['Sty','Lut','Mar','Kwi','Maj','Cze','Lip','Sie','Wrz','Paz','Lis','Gru'];
		var dayArray = ['Pon','wt','Sr','czw','Pia','So','Nie'];
		var weekString = 'tydzien';
		var todayString = '';
		break;	
}
