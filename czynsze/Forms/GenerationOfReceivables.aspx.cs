            ...
            using (DostępDoBazy.CzynszeKontekst db = new DostępDoBazy.CzynszeKontekst())
            {
                ...
                if (String.IsNullOrEmpty(generationMode))
                    ...
                    else
                    {
                        ...
                        placeOfGeneration.Controls.Add(new MyControls.TextBox("field", "fromBuilding", db.AktywneLokale.Min(p => p.kod_lok).ToString(), MyControls.TextBox.TextBoxMode.Number, 5, 1, true));
                        placeOfGeneration.Controls.Add(new MyControls.Label("label", "fromPlace", " Numer pierwszego lokalu: ", String.Empty));
                        placeOfGeneration.Controls.Add(new MyControls.TextBox("field", "fromPlace", db.AktywneLokale.Min(p => p.nr_lok).ToString(), MyControls.TextBox.TextBoxMode.Number, 3, 1, true));
                        AddNewLine(placeOfGeneration);
                        placeOfGeneration.Controls.Add(new MyControls.Label("label", "toBuilding", "Numer budynku ostatniego lokalu: ", String.Empty));
                        placeOfGeneration.Controls.Add(new MyControls.TextBox("field", "toBuilding", db.AktywneLokale.Max(p => p.kod_lok).ToString(), MyControls.TextBox.TextBoxMode.Number, 5, 1, true));
                        placeOfGeneration.Controls.Add(new MyControls.Label("label", "toPlace", " Numer ostatniego lokalu: ", String.Empty));
                        placeOfGeneration.Controls.Add(new MyControls.TextBox("field", "toPlace", db.AktywneLokale.Max(p => p.nr_lok).ToString(), MyControls.TextBox.TextBoxMode.Number, 3, 1, true));
                    }
                else
                {
