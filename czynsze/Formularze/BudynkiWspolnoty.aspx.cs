            ...
            using (DostępDoBazy.CzynszeKontekst db = new DostępDoBazy.CzynszeKontekst())
            {
                ...
                else
                {
                    ...
                    if (String.Equals(okno, "Dodaj"))
                    {
                        ...
                        pierwszaKontrolka = new Kontrolki.DropDownList("field", "kod_1", db.Budynki.AsEnumerable().OrderBy(b => b.kod_1).Select(b => b.PolaDoTabeli().ToArray()).ToList(), true, false);
                    }
                    else
                    {
                ...
                placeOfTable.Controls.Add(new Kontrolki.Table("mainTable tabTable", wiersze, new string[] { "Lp.", "Nr budynku", "Adres", "Uwagi" }, new Kontrolki.InformacjeOSortowalnościTablicy(), String.Empty, new List<int>() { 1, 2 }, new List<int>(), String.Empty));
            }
        }
    }
}